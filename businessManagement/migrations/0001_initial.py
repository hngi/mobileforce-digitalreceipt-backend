# Generated by Django 3.0.7 on 2020-08-01 04:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('versionNumber', models.CharField(max_length=1000, null=True)),
                ('isPromotion', models.BooleanField(default=True, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Receipts',
            fields=[
                ...
                ('business', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='businessManagement.BusinessInfo')),
